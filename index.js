...
function gene() {
  ;
   for (let i = 0; i < names.length; i++) {
       ...
       document.querySelector(".details-para").style.backgroundColor="rgba(128, 128, 128, 0.089)"
   }
}
...
function handleClick() {
    ...
    document.querySelector(".details-para").innerHTML = `${name} Here's Your new account`;
    document.querySelector(".welcome").innerHTML = " warm welcome to your account ";
    names.push(name)
    console.log(names);
...
function deletes() {
    ...
    if (names.includes(deleteName)) {
        document.querySelector(".details-para").innerHTML = "Your account has been deleted";
        document.querySelector(".welcome").innerHTML ="Hope so be there Soon AGAIN";
    var i = names.indexOf(deleteName)
        names.splice(i,1)
        document.querySelector(".details-para").style.backgroundColor="#ffadad"
    }else{
        document.querySelector(".details-para").innerHTML = " Sorry this account dose not detected";
        document.querySelector(".details-para").style.backgroundColor="rgba(128, 128, 128, 0.089)"
    }
...
function Login() {
    ...
    if (names.includes(loginName)) {
        document.querySelector(".details-para").innerHTML = " Here You go,Your account has been login";
        document.querySelector(".details-para").style.backgroundColor="#c8ffad"
    }
    else {
        document.querySelector(".details-para").innerHTML = " Sorry,we did'nt found this account";
        document.querySelector(".details-para").style.backgroundColor="rgba(128, 128, 128, 0.089)"
    }
}
